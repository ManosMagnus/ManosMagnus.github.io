...
BLOG_AUTHOR = "Manos Kirtas"  # (translatable)
BLOG_TITLE = "Google Summer of Code 2019"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://manosmagnus.github.io/GSoC_19/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://manosmagnus.github.io/GSoC_19/"
BLOG_EMAIL = "manolis.kirt@gmail.com"
BLOG_DESCRIPTION = "Blog is used for GSoC2019 so as to provide information about my project which is titled as \"WebSocket Scanning with OWASP/ZAP\" under OWASP Foundation."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://twitter.com/Kir_Manos', 'My Twitter', 'fab fa-twitter'),
        ('https://github.com/ManosMagnus', 'My Github', 'fab fa-github'),
    )
}
...
THEME_CONFIG = {
    DEFAULT_LANG: {
        ...
        'sidebar': '',
        'previewimage': '/images/zap512x512.png'
    }
}
